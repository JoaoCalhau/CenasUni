 ...
 * USAGE:
 * <pre>
 *        NewJerseyClientId client = new NewJerseyClientId();
 ...
 * @author João
 */
public class NewJerseyClientId {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:36764/tasd/";

    public NewJerseyClientId() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("customers/newId");
    }
     ...
     */
    public void putCustomer(String id) throws ClientErrorException {
