...
public class MenuClient {
    ...
    private static void listarQuestionarios(OperacoesBD obj) throws RemoteException {
    ...
    private static void responderQuestionarios(OperacoesBD obj) throws RemoteException {
        //to do
        Scanner sc = new Scanner(System.in);
        int tamanho= obj.returnContador();
        if(tamanho==0) {
    ...
    private static void verQuestoesQuestionario(OperacoesBD obj) throws RemoteException {
        Scanner sc = new Scanner(System.in);
        int tamanho= obj.returnContador();
        if(tamanho==0) {
            System.out.println("Nao existem questionarios guardados!");
    ...
    private static void verMediaQuestionario(OperacoesBD obj) throws RemoteException {
        //to do
        Scanner sc = new Scanner(System.in);
        int tamanho= obj.returnContador();
        if(tamanho==0) {
    ...
    private static void verVezesQuestionario(OperacoesBD obj) throws RemoteException {
        Scanner sc = new Scanner(System.in);
        int tamanho= obj.returnContador();
        if(tamanho==0) {
            System.out.println("Nao existem questionarios guardados!");
    ...
    private static void criarQuestionario(OperacoesBD obj) throws RemoteException {
    ...
    private static void apagarQuestionario(OperacoesBD obj) throws RemoteException {
        Scanner sc = new Scanner(System.in);
        int tamanho= obj.returnContador();
        if(tamanho==0) {
            System.out.println("Nao existem questionarios guardados!");
    ...
    public static void mainMenu(OperacoesBD obj) throws RemoteException {
	...
	regPort= args[1];
        ...
        try {
            OperacoesBD obj =
            (OperacoesBD) java.rmi.Naming.lookup("rmi://" + regHost + ":" + 
                                          regPort + "/quest");
