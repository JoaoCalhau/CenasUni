...
public class MenuServer {
	...
	if (args.length != 5) { 
	    ...
	    System.out.println("Example: java so2.MenuServer 9000 alunos.di.uevora.pt l31621 l31621 12345");
	    System.exit(1);
	}
	...
	try {
        ...
        OperacoesBDImpl obj = new OperacoesBDImpl(args[1], args[2], args[3], args[4]);
