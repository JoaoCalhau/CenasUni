...
public class ListaQuestionariosImpln extends UnicastRemoteObject implements ListaQuestionariosn, java.io.Serializable {

    Connection con = null;
    Statement stmt = null;
    
    
    public ListaQuestionariosImpln(String host, String db, String user, String pw) throws java.rmi.RemoteException, Exception {
        try {
