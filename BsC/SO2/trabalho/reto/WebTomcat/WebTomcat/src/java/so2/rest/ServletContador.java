...
public class ServletContador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Numero de vezes que foi respondido</h1>");
            ...
            String n = request.getParameter("contadorcenas");
            ...
            if(!c1){
                ...
                for(Questionarios quest: cenas){
                    if(quest.getNumQuest() == numQuest){
                        Pergunta p = quest.perg.get(0);
                        out.println("<p>" + quest.getNumQuest() + " - " + quest.getNomeQuest() + ": " + p.getCount() + "</p>");
                    }
                }
            }
