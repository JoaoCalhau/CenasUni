...
op((S, (X, Y)), desce, (S, (Z, Y)), 1) :- profundidade(Prof),
										X < Prof, 	
										K is X+1,
										(visited((K,Y))
											-> fail	
...
op((S, (X, Y)), dir, (S, (X, Z)), 1) :- largura(Larg),
										K is Y+1,
										Y < Larg,
										(visited((X,K))
											-> fail
