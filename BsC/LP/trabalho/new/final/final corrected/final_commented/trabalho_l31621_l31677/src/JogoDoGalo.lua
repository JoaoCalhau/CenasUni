...
function TicTacToe()
	...
	--[ inicializa uma tabela com n * n posicoes ]--
	...
	--[ Funcao principal para fazer uma jogada com o simbolo p na posicao (i, j) ]--
