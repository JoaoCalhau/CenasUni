public class Hamming {
	...
	/*
	 * A funcao hammingCode passa uma string de entrada, a cada 4 bits, para uma nova string 
	 * String esta que vai ter os 4 bits codificados em 7 bits (os 3 novos sendo check bits)
	 * dados pelo algoritmo de Hamming dado nas aulas
	 */
	...
	/*
	 * A funcao hammingDecode passa uma string de entrada, a cada 7 bits, para uma nova string
	 * String esta que vai ser corrigida (se tiver erros) com o codigo de Hamming dado nas aulas
	 */
